...
const SEMESTER_PRESETS: SemesterPreset[] = [
  ...
  {
    "label": "SE Year 2 w/electives - Semester 2",
    "request": {
      "topN": 10,
      "courses": [
        {
...
},
{
  ...
  workspace: {
    ...
    rules: defaultRules(),
    semesters: {
      SEMESTER_1: { courses: SEMESTER_PRESETS[1].request.courses },
      SEMESTER_2: { courses: SEMESTER_PRESETS[2].request.courses },
    }
  }
},
{
  ...
  "workspace": {
    ...
    "semesters": {
      "SEMESTER_1": {
        "courses": SEMESTER_PRESETS.find((preset) => preset.label === "EE Year 3 - Semester 1")!.request.courses
      },
      "SEMESTER_2": {
        "courses": SEMESTER_PRESETS.find((preset) => preset.label === "EE Year 3 - Semester 2")!.request.courses
      }
    }
  }
}];
